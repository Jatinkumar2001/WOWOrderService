...
public interface OrderItemRepository extends JpaRepository<OrderItemEntity, UUID> {
    ...
    String ORDER_META_WITH_SKU = "select om.id,om.user_tracking_id,om.coupon_id,om.user_id,om.order_status,om.payment_method,om.payment_mode, "
            ...
            +"inner join oms.order_items_meta oim on om.user_tracking_id =  oim.user_tracking_id where om.user_id = ?1 group by om.id";
    String ORDER_META_WITH_SKU_COUNT = "select count(DISTINCT om.user_tracking_id) from oms.orders_meta"
